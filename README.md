...
express destructors all the code that goes into starting a server and allows us to use routing for cleaner easier to read files

- [x] Describe Middleware?

middleware intercepts data and passes it along to other middleware or to the client and will read the data based on how we set it up

- [x] Describe a Resource?

everything is a resource :D which means any piece of data available and all our end points
...
by deciding who will use what endpoints and how those endpoints interact with our database
